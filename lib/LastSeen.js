/**
 * lastSeen.js — shared helper for rendering presence text
 * ("Active now" / "Active 5m ago" / "Last seen 3 Jun") across
 * DM pages and Players page. Always prefer the LIVE presence
 * channel (useIsOnline / useOnlineUsers) over the DB online_status
 * column — that column can get stuck stale if beforeunload never
 * fires (very common on mobile browsers / PWAs).
 */
