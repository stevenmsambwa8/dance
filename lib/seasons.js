...
// ── Level System (1–100) ──────────────────────────────────────────────────────
// Rules:
//   Level 1–2:   2 season wins to advance
//   Level 3–24:  5 season wins to advance
//   Level 25–99: 15 season wins to advance
//   Level 100:   max, no advancement
//   Season end:  if wins < threshold → drop 1 level (min 1)
//
// NOTE: thresholds scaled down (Jul 2026) — typical active players were
// logging under 5 wins/season, making the old 10/25/100 curve unreachable.
...
// NOTE: thresholds scaled down (Jul 2026) — see level system note above.
...
export const LOSS_DROP_THRESHOLD = 15
