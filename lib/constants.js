...
export const GAME_META = {
  ...
  dls:          { name: 'DLS26',          full: 'Dream League Soccer',             genre: 'Football / Sports',   icon: 'ri-ball-pen-line', image: '/games/dls.png',        desc: 'Best game so far! Build your dream team and compete in leagues, cups, and online tournaments.' },
    ufl:          { name: 'UFL',          full: 'UFL mobile',             genre: 'Football / Sports',   icon: 'ri-football-line', image: '/games/ufl.png',        desc: 'New game, unlimited football tournaments inside.' },
    cpm2:         { name: 'CPM 2',        full: 'Car Parking Multiplayer 2',       genre: 'Simulation / Racing', icon: 'ri-car-line',      image: '/games/cpm2.png',       desc: 'Open-world parking and driving simulator with 170+ cars, tuning, racing, police and taxi modes, and live multiplayer.' },
}
