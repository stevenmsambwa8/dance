...
export default function NotificationsPage() {
  ...
  if (!user) return (
    <div className={styles.page}>
      <div className={styles.empty}><i className="ri-lock-line" /><p>Log in to see notifications</p><button onClick={openAuthGate} className={styles.loginBtn}>Log In</button></div>
    </div>
  )
