                ...
                <Link key={t.id} href={href} className={styles.tCard}>
                  <div className={styles.tCardTop}>
                    <div className={styles.tCardMeta}>
                      ...
                      {/* Entry fee badge */}
                      {fee && (
                        <span className={styles.tFeeBadge}><i className="ri-money-dollar-circle-line" /> {fmtAmt(fee)}</span>
                      )}
                  ...
                  <div className={styles.tCardStats}>
                    {parsePrize(prize) && <span><i className="ri-trophy-line" />{fmtAmt(parsePrize(prize))}</span>}
                ...
                <Link key={item.id} href={`/shop/${item.id}`} className={styles.shopCard}>
                  ...
                  <div className={styles.shopCardBody}>
                    ...
                    <div className={styles.shopCardFooter}>
                      <span className={styles.shopPrice}>{price ? fmtAmt(price) : currencyMeta?.symbol + ' —'}</span>
