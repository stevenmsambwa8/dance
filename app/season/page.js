        ...
        <div className={styles.headerTop}>
          <div className={styles.headerLeft}>
            ...
            <h1 className={styles.title}>
              ...
              <UserBadges email={profile?.email} plan={profile?.plan} planExpiresAt={profile?.plan_expires_at} countryFlag={profile?.country_flag} isSeasonWinner={profile?.is_season_winner} customBadges={profile?.custom_badges} size={16} gap={4} />
            </h1>
          </div>
