                    ...
                    <div className={styles.content}>
                      <div className={styles.players}>
                        <span className={styles.pname}>
                          ...
                          <UserBadges email={m.challenger?.email} plan={m.challenger?.plan} planExpiresAt={m.challenger?.plan_expires_at} countryFlag={m.challenger?.country_flag} isSeasonWinner={m.challenger?.is_season_winner} customBadges={m.challenger?.custom_badges} size={11} gap={2} />
                        </span>
                        <span className={styles.vs}>vs</span>
                        <span className={styles.pname}>
                          {isRecruiting ? <em style={{ color: 'var(--text-muted)', fontStyle: 'normal' }}>Open slot</em> : (m.challenged?.username || '—')}
                          {!isRecruiting && <UserBadges email={m.challenged?.email} plan={m.challenged?.plan} planExpiresAt={m.challenged?.plan_expires_at} countryFlag={m.challenged?.country_flag} isSeasonWinner={m.challenged?.is_season_winner} customBadges={m.challenged?.custom_badges} size={11} gap={2} />}
                        </span>
                      </div>
                  ...
                  <div className={styles.content}>
                    <div className={styles.players}>
                      ...
                      <span className={`${styles.pname} ${cdWon ? styles.pnameWon : ''} ${isCompleted && !cdWon && m.winner_id ? styles.pnameLost : ''}`}>
                        ...
                        <UserBadges email={m.challenged?.email} plan={m.challenged?.plan} planExpiresAt={m.challenged?.plan_expires_at} countryFlag={m.challenged?.country_flag} isSeasonWinner={m.challenged?.is_season_winner} customBadges={m.challenged?.custom_badges} size={11} gap={2} />
                      </span>
