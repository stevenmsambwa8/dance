  ...
  if (!user) return (
    <div className={styles.page}>
      <p style={{ color: 'var(--text-muted)', padding: '60px 0', textAlign: 'center' }}>
        Please <button onClick={openAuthGate} style={{ background:'none', border:'none', color:'var(--text)', fontWeight:700, cursor:'pointer', padding:0, textDecoration:'underline', fontFamily:'var(--font)' }}>log in</button> to view your matches.
      </p>
    </div>
  )
